...
<div class="center belowDivHeader" style="height:600";>  <!-- aukštį nusirodai kokio reikia, priklausomai nuo mygtukų -->
    <div class="card">
       <!-- TALPINTI KODA ČIA -->
       ...
       <button class="button">
            ...
            <small>Dažniausiai pasikartojančios klaidos</small>
            </p>
       </button>
       <button class="button">
