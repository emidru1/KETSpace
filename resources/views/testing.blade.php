       ...
       <!-- TALPINTI KODA ČIA -->
  	   ...
  	   <!-- TALPINTI KODA ČIA -->
            <p>
       		...
       		<small style="font-size:15px"><b>Visų kategorijų klausimyną sudaro apie 50 klausimų. Testas sudaromas atsitiktinę tvarka,<br/> pasirenkant klausimus iš 2 teminių skyrių pagal programos nurodytą algoritm.</b></small>
            </p>
       <button class="button" href="https://ketspace.xyz/public/topics/1">
