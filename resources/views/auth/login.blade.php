...
<div class="center aboveDivHeader">
    ...
    <p>Įveskite savo el. paštą ir slaptažodį, kuriuos nurodte registracijos metu</p>
</div>
<div class="center belowDivHeader" style="height:200px">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header" style="color:RGB(238,238,238)">{{ __('Login') }}</div>
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                      ...
                      <div class="columnLeft">
                          <div class="padding_for_inside alignerRight">
                            <label for="email" class="col-md-4 col-form-label text-md-end">{{ __('El. paštas:') }}</label></div>
                          <div class="padding_for_inside alignerRight">
                      ...
                      <div class="columnRight">
                        ...
                        <div class="padding_for_inside" style="padding-top:0">
