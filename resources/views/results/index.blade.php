...
<div class="center aboveDivHeader">
    <h1>Statistika</h1>
    <p>Čia galite peržiūrėti savo spręstus KET testus, įvertinti savo atliktas klaidas bei peržiūrėti atlikimo datą.</p>
</div>
<div class="center belowDivHeader" style="height:fit-content;" ;>  <!-- aukšt nusirodai kokio reikia, priklausomai nuo mygtuk -->
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-body">
                                            ...
                                            <table class="table table-bordered table-striped datatable">
                                                <thead>
                                                <tr>
                                                    <th style="padding-left: 10px;">Vartotojas</th>
                                                    <th style="padding-left: 267px;">Data</th>
                                                    <th style="padding-left: 225px;">Rezultatai</th>
                                                    <th>&nbsp;</th>
                                                </tr>
                                                </thead>

                                                @foreach($allResults as $result)
                                                    <table style="border-radius: 10px; margin-left: 5px; border: 0px solid black; background-color:white; margin-top: 10px; margin-bottom: 5px;">
                                                        <td style="font-weight: bold; padding-left: 10px;">{{$result->user->name}} ({{$result->user->email}})</td>
                                                        <td style="font-weight: bold; padding-left: 100px; padding-top: 10px;">{{$result->created_at}}</td>
                                                        <td style="font-weight: bold; padding-left: 120px;">{{$result->correct_answers}}/{{$result->questions_count}}</td>
                                                        <td>
                                                            <a href="{{route('results.show', $result->id)}}"
                                                               class="btn btn-xs btn-primary">Rodyti</a>
                                                        </td>
                                                    </table>
                                              
                                                @endforeach
                                            </table>
                                            <button style="padding:10px 60px 1px 60px; font-weight: bold; font-size: large;">
